...
const bool TideEvent::isHighTide() const {
    return !isCurrent && eventType == TideEvent::max;
}

const bool TideEvent::isLowTide() const {
    return !isCurrent && eventType == TideEvent::min;
}
